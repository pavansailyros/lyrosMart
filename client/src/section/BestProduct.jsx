...
const BestProduct = () => {
  return (
    ...
    <div className="flex justify-between items-center mb-6">
      <h1 className="text-3xl font-bold text-green-600">Best Selling Products</h1>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {bestProducts.map((item) => (
        <div
          key={item.heading}
          className="bg-gray-100  border rounded-lg p-4 flex w-[270px] h-[322px] flex-col items-center"
        >
